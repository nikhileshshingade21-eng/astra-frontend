...
export default function App() {
  ...
  React.useEffect(() => {
        ...
        if (userJson) {
          ...
          if (token && user._id) {
            try {
              ...
              console.warn('⚠️ Notification setup skipped:', e.message);
            }
          }
        }
    ...
    notificationService.constructor.setupBackgroundHandler();
  }, []);
  ...
  return (
    <ErrorBoundary>
      <NavigationContainer 
        ...
        ref={navigationRef}
        onReady={() => {
          // Setup notification tap handler when navigation is ready
