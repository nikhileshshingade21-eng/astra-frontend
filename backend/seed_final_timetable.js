...
const schedule = [
    ...
    { day: 'Friday', code: 'DS-LAB', name: 'DS Lab', faculty: 'Mr. K Praveen Kumar', room: '220', start: '13:50', end: '16:00' },
    ...
    { day: 'Saturday', code: 'SSLITE', name: 'SSLite', faculty: 'Self Study', room: '214', start: '13:50', end: '14:50' },
    { day: 'Saturday', code: 'LIBRARY', name: 'Library', faculty: 'Self Study', room: 'Library', start: '15:00', end: '16:00' }
];
...
async function seed() {
    ...
    try {
        ...
        console.log('Inserting corrected schedule (DS Lab on Friday)...');
        ...
        console.log('SUCCESS: Timetable updated correctly!');
    } catch (err) {
