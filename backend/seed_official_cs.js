...
const classes = [
    ...
    { day: 'Monday', code: 'BEE LAB', name: 'Basic Electrical Engg. Lab', faculty: 'Dr. M Narendar Reddy', room: 'BEE Lab', start: '13:50', end: '16:00' },
    ...
    { day: 'Tuesday', code: 'LIB', name: 'Library', faculty: 'In-charge', room: 'Library', start: '15:00', end: '16:00' },

    // WEDNESDAY
    { day: 'Wednesday', code: 'SS', name: 'Soft Skills', faculty: 'Atoshi Roy', room: 'Seminar Hall', start: '09:00', end: '12:10' },
    { day: 'Wednesday', code: 'BEE', name: 'Basic Electrical Engg.', faculty: 'Dr. M Narendar Reddy', room: '214', start: '12:50', end: '13:50' },
    { day: 'Wednesday', code: 'AEP LAB', name: 'Engg. Physics Lab', faculty: 'Mrs. T Sreevani', room: 'H&S Lab', start: '13:50', end: '16:00' },
    ...
    // FRIDAY
    { day: 'Friday', code: 'EDCAD', name: 'Engg. Drawing & CAD', faculty: 'Dr. K Govardhan Reddy', room: '320', start: '09:00', end: '10:00' },
    ...
    // SATURDAY
    { day: 'Saturday', code: 'EDCAD', name: 'Engg. Drawing & CAD (Labor)', faculty: 'Dr. K Govardhan Reddy', room: '320', start: '09:00', end: '12:10' },
    { day: 'Saturday', code: 'ODEVC', name: 'ODE & Vector Calculus', faculty: 'Mrs. A Swarnalatha', room: '214', start: '12:50', end: '13:50' },
    { day: 'Saturday', code: 'SPORTS', name: 'Sports', faculty: 'In-charge', room: 'Ground', start: '13:50', end: '14:50' },
    { day: 'Saturday', code: 'SSLITE', name: 'Soft Skills Lite', faculty: 'Atoshi Roy', room: 'Seminar Hall', start: '15:00', end: '16:00' }
];

async function seed() {
    try {
        console.log('Clearing existing classes for Section CS...');
        ...
        console.log(`✅ Successfully seeded ${count} official classes for Section CS.`);
    } catch (err) {
